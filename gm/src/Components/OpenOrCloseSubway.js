...
export default function OpenOrCloseSubway(props) {
  ...
  const [subwayEdge, setSubwayEdge] = React.useState('');
  ...
  return (
    <div style={{ width: 300, height: 230, margin: 'auto', display: 'flex', flexDirection: 'column', borderRadius: '3%', border: '1px solid grey', boxShadow: '10px 5px 5px grey' }}>
      <h3> Teleport</h3>
      <TextField label='Metro Edge' onChange={handleChangeSubwayEdge}/>
